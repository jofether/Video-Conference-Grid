...
export default function Header({ meetingTitle, meetingInfo, callDuration, participants }) {
  ...
  return (
    <header className="bg-gradient-to-r from-slate-900/90 to-slate-800/90 backdrop-blur-2xl border-b border-slate-700/50 px-6 py-4 flex justify-between items-center shadow-2xl">
      ...
      <div className="flex items-center gap-8">
        <div className="text-center">
          <div className="text-2xl font-mono font-bold text-cyan-400 bg-slate-800/50 px-4 py-2 rounded-lg border border-cyan-500/30">
